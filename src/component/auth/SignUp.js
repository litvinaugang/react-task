...
class SignUp extends React.Component {
  constructor(props) {
    ...
    this.handleClickShowPhone = this.handleClickShowPhone.bind(this);
          ...
          <Box className={`flex flex-col items-center mx-auto ${classes.signinwidth}`}>
            ...
            >
              ...
              >
                ...
                >
                  <FormControl className={`${classes.formcontrol} h-16 w-full`}>
                    <InputLabel shrink htmlFor="phone-number">Phone Number</InputLabel>
                    <Box className="flex">
                      <Box className={`mr-6 ${classes.customselect}`}>
                        <ReactCustomFlagSelect
                          ...
                          customStyleWrapper={{}}
                          customStyleContainer={{ border: "none", fontSize: "16px" }}
                          customStyleSelect={{ width: "50px" }}
                      ...
                      <Input
                        id="phone-number"
                        type={this.state.showPhone ? 'text' : 'password'}
                        required
                        className={`${classes.textField} flex-grow h-16`}
                        endAdornment={
                          <InputAdornment position="end">
                            <IconButton
                              aria-label="toggle password visibility"
                              onClick={this.handleClickShowPhone}
                              onMouseDown={this.handleMouseDownPhone}
                            >
                              {this.state.showPhone ? <Visibility /> : <VisibilityOff />}
                            </IconButton>
                          </InputAdornment>
                        }
                      />
